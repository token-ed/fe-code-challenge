      ...
      try {
        ...
        setTimeout(async () => {
          ...
          const professionalsWithPagination: ProfessionalsWithPagination = {
            ...
            // json-server does not return any headers or information about the length of records for professionals so we will assume the length is 148 (db.json)
            totalPages: Math.floor(148 / ENTRIES_PER_PAGE),
          };
